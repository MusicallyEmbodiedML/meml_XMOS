...
- Peripherals: I2C, I2S (pulled from the XCommon CMake build system), UART modified to compile as c++ from ...
...
## Pi Pico repository
TODO: Link to the Pi Pico firmware for reading the joystick
